    ...
    <div className="auth-page">
      ...
      <div className="auth-card auth-card-wide">
        ...
        <form onSubmit={handleSubmit} className="auth-form">
          ...
          <div className="form-row">
            <Field name="password" label="Password" errors={errors}>
            ...
            <Field name="confirmPassword" label="Confirm Password" errors={errors}>
          ...
          <div className="form-row">
            <Field name="course" label="Course" errors={errors}>
              <select value={form.course} onChange={set('course')}>
                {COURSES.map((c) => <option key={c} value={c}>{c}</option>)}
              </select>
            </Field>
            <Field name="batch" label="Batch (e.g. 2025A)" errors={errors}>
              <input value={form.batch} onChange={set('batch')} placeholder="2025A" />
            </Field>
          </div>
          <div className="form-row">
            <Field name="ojt_start_date" label="OJT Start Date" errors={errors}>
              <input type="date" value={form.ojt_start_date} onChange={set('ojt_start_date')} />
            </Field>
            <Field name="required_hours" label="Required Hours" errors={errors}>
